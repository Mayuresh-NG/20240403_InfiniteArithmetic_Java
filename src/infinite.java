...
class infinite {
    ...
    public infinite(Object inputObject) {
        if (inputObject instanceof Integer) {
        ...
        } else if (inputObject instanceof String inputString) {
            ...
            System.out.println(internalList);
        } else if (inputObject instanceof int[] inputArray) {
    ...
    public int div(infinite toDiv) {
        ...
        int dividend = convertListToNumber(internalList);
        int divisor = convertListToNumber(toDiv.internalList);
